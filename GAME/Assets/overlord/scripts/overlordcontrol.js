...
private var reference : Transform;
 public class overlordcontrol extends NetworkBehaviour {

function Start()
{
     reference = new GameObject().transform; 
     	var helperscript: characterhelper =  GetComponent(characterhelper); 

helperscript.changecolor();
}
function Update()
{
...
//////////////////////////////////////////////
public function OnStartLocalPlayer(): void
{
